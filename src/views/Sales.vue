...
function check() {
    ...
    if (checkmark.checked == true) {
        vsrc.src = "https://www.youtube.com/embed/FU-n8qxCW2o?si=n49VEadxCmmJ76eo&amp;controls=1"
    }
}
</script>
<template>
    <div id="darkmode" class="darkmode">
        <div class="top mt-10 justify-center mx-auto p-5 space-y-5 md:w-11/12 bg-gray-200 dark:bg-gray-900 dark:text-white">
            <img class="mx-auto w-1/2 md:w-1/6" src="/sales.svg" width="100%" height="100%" alt="marketing">
