...
<template>
    <div class="about p-1 md:p-10 flex-col justify-center h-full dark:bg-gray-950 dark:text-white reveal1">
        <h1 class="text-2xl md:text-5xl dark:text-white text-center font-bold p-2">Reset Password</h1>
        ...
        <form id="form" class="space-y-5 p-5 h-screen text-center mx-auto justify-center flex-col"
            ...
            <button @click="" type="submit"
                class="px-5 py-2 md:w-1/4 mx-auto rounded-md hover:cursor-pointer hover:bg-gray-300 bg-gray-400 dark:hover:bg-gray-900 dark:bg-gray-700">
                Send reset link
            </button>
        </form>
    </div>
