...
<template>
    <div class="about p-1 md:p-10 flex-col justify-center h-full bg-gray-950 text-white reveal1">
        <h1 class="text-5xl text-white text-center font-bold p-2">Reset Password</h1>
        ...
        <form id="form" class="space-y-5 p-5 h-screen text-center mx-auto justify-center flex-col"
            ...
            <div class="form mt-3">
                <label class="p-3 text-xl">Email</label>
                <input id="email" v-model="user.email"
                    class="bg-gray-200 text-black p-2 ml- rounded-md focus:outline-none md:w-1/5 " type="email" required />
            </div>
            <button @click="" type="submit"
                class="px-5 py-2 w-48 mx-auto rounded-md hover:cursor-pointer hover:bg-gray-900 bg-gray-700">
                Send reset link
            </button>
        </form>
    </div>
